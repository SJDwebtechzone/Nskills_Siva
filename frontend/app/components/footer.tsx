  ...
  const footerLinks = [
    {
      ...
      links: [
        { name: "Basic Course", href: "/skill-training#basic" },
        { name: "Advance Course", href: "/skill-training#advance" },
        { name: "International Course", href: "/skill-training#international" },
      ],
    },
    {
      title: "Corporate Training",
      links: [
        { name: "Management Training", href: "/corporate#management" },
        { name: "Commerce", href: "/corporate#commerce" },
        { name: "Soft Skills", href: "/corporate#soft-skills" },
        { name: "Lean Six Sigma", href: "/corporate#six-sigma" },
        { name: "Customised Training", href: "/corporate#custom" },
        { name: "& more training", href: "/corporate" },
      ],
    },
    {
      title: "Consulting Services",
      links: [
        { name: "Strategic Management", href: "/consulting#strategic" },
        { name: "Industrial Design & Layout", href: "/consulting#design" },
        { name: "Audits", href: "/consulting#audits" },
        { name: "Logistics & Warehousing", href: "/consulting#logistics" },
        { name: "Manufacturing Excellence", href: "/consulting#manufacturing" },
